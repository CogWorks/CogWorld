    ...
    switch [lindex $x 0] {
      ...
      size { 
        ...
        while {$x <= $size} {
          ...
          $win.frame.canvas create text $x 400 -text [expr 0.001 * $x] -anchor sw -font graphic_trace_font -tag trace_items
          incr x 50
        }
      }
...
# user restricted range
  ...
  while {$x <= $max_x} {
    ...
    $win.frame.canvas create text [expr $x - $min_x] 400 -text [expr 0.001 * $x] -anchor sw -font graphic_trace_font -tag trace_items
    incr x 50
  }
