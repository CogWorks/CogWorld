...
proc make_bold_graphs {} {
  ...
  checkbutton $win.check -text "Scale across regions" -variable $win.checkbox -onvalue nil -offvalue t -command "select_buffer_graph $list_box $win.frame.canvas $win"
