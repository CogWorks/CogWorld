  ...
  (unless (or (check-jam mtr-mod) (check-specs (or loc object) device))
    (let ((r-theta nil)
      ...
      (setf feat  ;; always refer back to the visicon chunks if possible
        (cond ((and object (chunk-visicon-entry object) (chunk-p-fct (chunk-visicon-entry object)))
               (chunk-visicon-entry object))
              ((and object (chunk-slot-value-fct object 'screen-pos)
               ...
               (if (chunk-p-fct (chunk-visicon-entry (chunk-slot-value-fct object 'screen-pos)))
                    (chunk-visicon-entry (chunk-slot-value-fct object 'screen-pos))
                 (chunk-slot-value-fct object 'screen-pos)))
              ((and loc (chunk-visicon-entry loc) (chunk-p-fct (chunk-visicon-entry loc)))
               (chunk-visicon-entry loc))
